...
for (var mm in grungeAlbumsJSON) {
    console.log(grungeAlbumsJSON[mm]);
...
var grungeAlbumsBtoJSON = JSON.parse(grungeAlbumsJSON);
for (var mm in grungeAlbumsBtoJSON) {
    console.log(grungeAlbumsBtoJSON[mm]);
